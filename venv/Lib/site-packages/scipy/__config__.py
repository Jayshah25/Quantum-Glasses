...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.13.1",
                "include directory": r"C:\Users\runneradmin\AppData\Local\Temp\pip-build-env-gwuhujd5\overlay\Lib\site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"C:\Users\runneradmin\AppData\Local\Temp\cibw-run-t4t9eut3\cp310-win_amd64\build\venv\Scripts\python.exe",
            "version": "3.10",
        },
    }
)
